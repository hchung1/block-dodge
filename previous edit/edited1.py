...
def message_display (text):
    ...
    TextSurf, TextRect = message_setting(text, largeText)
...
def crash():
    message_display('You Got Smacked')
#Wall collision
def knockedout():
    message_display('Knocked Out By Wall')
...
def game_loop():
    ...
    i = 1
    #Range of Colors
    color_range = [black, white, blue, orange, red, green]
    oppisite_range = [white, black, orange, blue, green, red]
